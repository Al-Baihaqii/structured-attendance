...
export default async function DashboardPage() {
  ...
  return <div>
    ...
    <div className={`mt-8 grid gap-6 ${canReadActivityLogs ? "xl:grid-cols-[1.35fr_0.65fr]" : ""}`}>
