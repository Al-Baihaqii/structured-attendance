...
import { MeetingAttendanceForm } from "./meeting-attendance-form";
    ...
    <div className="grid gap-6 xl:grid-cols-[1fr_340px]">
      <div className="space-y-6">
        ...
        <Card className="overflow-hidden">
          ...
          {canCreateMeeting && <div className="border-b border-line p-5"><MeetingAttendanceForm groupId={group.id} nextMeetingNumber={Math.max(0, ...group.attendanceSessions.map(meeting => meeting.meetingNumber)) + 1} members={activeMembers} /></div>}
